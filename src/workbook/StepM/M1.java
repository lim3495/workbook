...
class MenuList{
	...
	String output_save(int i) {
		
		return (i+1)+"\t"+this.menu+"\t"+this.from+"\t"+this.price;
	}
	...
	void saveFile() throws IOException {
		  ...
		  FileWriter fw = new FileWriter("/Users/lim-eunchae/git/workbook/src/workbook/StepM/stepm1.txt ");
		  fw.write("메뉴번호\t메뉴이름\t원산지\t1인분가격\n");
		  
		  for(int i=0;i<m.size();i++)
			  fw.write(m.get(i).output_save(i)+"\n");
		  fw.close();
